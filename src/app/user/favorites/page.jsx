    ...
    <div className='flex min-h-screen flex-col place-content-start space-y-8'>
      ...
      <div className='flex flex-col'>
        ...
        <p className='text-lg text-gray-600'>
          Here you can view all of your favorites, including their status.
        </p>
      </div>

      {/* applications list */}
      <div className='flex flex-col'>
        <h2 className='text-xl font-extrabold text-gray-500'>Favorites list</h2>
        <p className='text-md text-gray-400'>
          Here is a list of all of your favorites.
        </p>
      </div>
    </div>
  )
