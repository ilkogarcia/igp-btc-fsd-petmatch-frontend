...
const ResetPasswordPage = async () => {
  ...
  useEffect(() => {
    const verify = async () => {
      const res = await resetMyPassword(token)
        ...
        <div className='flex flex-col justify-evenly lg:col-span-6 lg:h-auto'>
          {isVerified ? (
            <div className='mx-auto w-3/4 text-center align-middle'>
              ...
              <p className='mb-8 mt-2 text-xs text-gray-400 md:text-sm lg:text-base'>
                Your email has been{' '}
            ...
            <div className='mx-auto w-3/4 text-center align-middle'>
              ...
              <p className='mb-8 mt-2 text-xs text-gray-500 md:text-sm lg:text-base'>
                Your email has{' '}
